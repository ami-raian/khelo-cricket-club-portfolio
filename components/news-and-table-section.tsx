  ...
  const newsItems = [
    {
      ...
      date: "May 20, 2024",
      title: "Latest Point Table For The IPL Championship",
      description:
        "The season is at its peak as we move into the final stages and look to achieve glory in this thrilling championship...",
    },
    {
      id: 2,
      image: "/latest-news.jpg",
      date: "May 18, 2024",
      title: "Everything in Cricket Starts The Premier League",
    },
    {
      id: 3,
      image: "/latest-news.jpg",
      date: "May 16, 2024",
      title: "City Tops Chennai in Community Shield Hero",
    },
    {
      id: 4,
      image: "/latest-news.jpg",
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <div className="text-center lg:text-left">
                ...
                <div className="w-20 h-1 bg-gradient-to-r from-blue-600 to-purple-600 mx-auto lg:mx-0"></div>
              </div>
              ...
              <div className="space-y-8">
                ...
                <Card className="overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border-0 bg-white/80 backdrop-blur-sm">
                  ...
                  <CardContent className="p-8">
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-gray-800 hover:text-blue-600 transition-colors cursor-pointer">
                      {newsItems[0].title}
                    </h3>
                  ...
                  <CardContent className="p-0">
                    ...
                    <div className="divide-y divide-slate-700">
                      {pointsTable.map((team, index) => (
                        <div
                          key={index}
                          className="px-6 py-4 hover:bg-slate-800/50 transition-all duration-200 group"
                        >
                          <div className="flex justify-between items-center">
                            <div className="flex items-center space-x-4 flex-1">
                              ...
                              <div className="flex items-center space-x-3">
                                <div
                                  className={`w-4 h-4 rounded-full ${team.color}`}
                                ></div>
                ...
                <Card className="overflow-hidden shadow-2xl border-0 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
                  <CardContent className="p-8">
                    <div className="text-center space-y-6">
                      ...
                      <div className="flex items-center justify-center text-sm text-blue-300 pt-4 border-t border-slate-700">
